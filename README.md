...
activation into the server command, commits workspace changes at process exit,
and keeps non-workspace changes for later review. With adaptive lifecycle,
...
session; when that inner session ends,
